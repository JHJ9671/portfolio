...
$(document).ready(function() {
    ...
    $('.gallery .link1 span').delay(1300).animate({top:400, opacity:1},'slow');
    ...
    //   }
      ...
      $('.mbutton').css('background','#eee'); //버튼불다꺼!!
      ...
      $('.gallery .link'+cnt).find('span').delay(1300).animate({top:400, opacity:1},'slow');
   ...
   $('.mbutton').click(function(event){  //각각의 버튼 클릭시
      ...
      //   $('.btn'+i).css('width','16');
		  // }
      $('.mbutton').css('background','#eee'); //버튼 모두불꺼
