 window.onload = function() {
    ...
    var options = {
        center: new daum.maps.LatLng(37.52172137846921, 126.91902699456179),
        level: 2
    };
    ...
    var markerPosition  = new daum.maps.LatLng(37.52172137846921, 126.91902699456179); 
    ...
    //광화문
      ...
      var container2 = document.getElementById('gwanghwamun');
    var options2 = {
        center: new daum.maps.LatLng(37.56857467363937, 126.98030155037421),
        level: 2
    };
    ...
    var markerPosition2  = new daum.maps.LatLng(37.56857467363937, 126.98030155037421); 
    ...
    // 분당
     ...
     var container3 = document.getElementById('bundang');
   var options3 = {
       center: new daum.maps.LatLng(37.35869968942686, 127.11488081613454),
       level: 2
   };
   ...
   var markerPosition3  = new daum.maps.LatLng(37.35869968942686, 127.11488081613454); 
   ...
   var overlay3 = new daum.maps.CustomOverlay({
    ...
    // 중구
     ...
     var container4 = document.getElementById('junggu');
   var options4 = {
       center: new daum.maps.LatLng(37.56595659014741, 126.99561391632503),
       level: 2
   };
   ...
   var markerPosition4  = new daum.maps.LatLng(37.56595659014741, 126.99561391632503); 
